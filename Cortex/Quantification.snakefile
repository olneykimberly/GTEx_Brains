...
# Directories
INPUT_DIR = "/scratch/mjpete11/GTEx/Cortex/trimmed_fastqs/"
SALMON_DIR = "/scratch/mjpete11/GTEx/Cortex/salmon_quants/"
HISAT_DIR = "/scratch/mjpete11/GTEx/Cortex/hisat_quants/"
...
# Samples
SAMPLES = config["Cortex_RNA_Trimmed"]

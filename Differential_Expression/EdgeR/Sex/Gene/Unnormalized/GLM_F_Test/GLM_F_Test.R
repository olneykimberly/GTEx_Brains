# This script looks at differential gene expression between females and males across all tissue without normalizing.


METADATA = "/scratch/mjpete11/GTEx/Metadata.csv"
COUNTS = "/scratch/mjpete11/GTEx/Data_Exploration/Count_Matrix.tsv"
PLOT_DIR =  "/scratch/mjpete11/GTEx/Differential_Expression/EdgeR/Sex/Gene/Unnormalized/GLM_F_Test/Plots/"

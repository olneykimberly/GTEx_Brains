...
# Directory variables
FASTQ_DIRECTORY = "/mnt/storage/public/dbgap-8834/brain_cerebellum"

# Samples
XX_SAMPLES = config["Cerebellum_RNA_Trimmed"]["Female"]
XY_SAMPLES = config["Cerebellum_RNA_Trimmed"]["Male"]
...
rule hisat2_align_reads:
    input:
        paired_1 = "/scratch/mjpete11/GTEx/Cerebellum/Quality_Control/trimmed_fastqs/{sample}_trimmomatic_trimmed_paired_1.fastq.gz",
        paired_2 = "/scratch/mjpete11/GTEx/Cerebellum/Quality_Control/trimmed_fastqs/{sample}_trimmomatic_trimmed_paired_2.fastq.gz",

...
rule hisat2_align_reads:
    input:
        paired_1 = "/scratch/mjpete11/GTEx/Amygdala/Quality_Control/trimmed_fastqs/{sample}_trimmomatic_trimmed_paired_1.fastq.gz",
        paired_2 = "/scratch/mjpete11/GTEx/Amygdala/Quality_Control/trimmed_fastqs/{sample}_trimmomatic_trimmed_paired_2.fastq.gz",
